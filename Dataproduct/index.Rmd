...
```{r combinations, echo = F}
x = c("123456", "password", "12345678", "qwerty", "abc123")
y = c(0.0025, 52, 0.025, 0.077, 0.5)
bars = data.frame(x, y)

plot(bars, main ="Passwords vs. seconds",  xlab = "User passoword", ylab = "Seconds taken to break")
